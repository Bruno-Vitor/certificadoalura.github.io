function gerar() {
  ...
  listalink = [
    '',
    'https://codepen.io/Bruno_br/pen/oNjdzmQ',
    'https://codepen.io/Bruno_br/pen/gOazwKN',
    'https://codepen.io/Bruno_br/pen/oNjdzoy',
    'https://codepen.io/Bruno_br/pen/abvGmJL',
  ]
  listalink1 = [
    '',
    'App de Corrida',
  ...
  while (contador > 0) {
    ...
    link1 = listalink1[contador];
    listalinkformatada = `<li><a href=${link}>${link1}</li> ` + listalinkformatada;
  ...
  `
  // imprimir = confirm("Deseja imprimir o Certificado?");
